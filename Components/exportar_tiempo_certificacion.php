...
$query = "SELECT cod,codigo,id,nombre,cliente,factura,cantidad,fecha,hora_inicio,
hora_fin,tiempo FROM resumen_picking WHERE fecha BETWEEN '$fecha_inicio' AND '$fecha_final'";
